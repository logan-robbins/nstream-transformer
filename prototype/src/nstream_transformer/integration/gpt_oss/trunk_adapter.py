"""Wrappers that expose GPT-OSS trunks to the N-Stream integration stack."""
...
class GptOssTrunkAdapter:
    """Adapter that anchors a GPT-OSS model inside the N-Stream stack.
    ...
    def __init__(self, config: TrunkAdapterConfig, *, model: Optional[PreTrainedModel] = None) -> None:
        self.config = config
        self._logger = logging.getLogger("nstream.gpt_oss.trunk")
