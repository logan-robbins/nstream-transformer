"""Unit tests for RoleState rollback behaviour."""
...
from nstream_transformer.inference.state import PastKeyValues, RoleState


def _make_state(*, role: str = "intro", commit_stride: int = 2, commit_horizon: int = 4) -> RoleState:
...
def test_role_state_rollback_restores_checkpoint() -> None:
